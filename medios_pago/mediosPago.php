		...
		<div class="row">
			<div class="col-md-6 mt-3">
				...
				<?php if(isset($_GET['mg'])): ?>
					<p class="alert alert-success">El medio de pago se ha eliminado correctamente</p>
				<?php endif; ?>
				...
				<?php if(isset($res) && count($res)): ?>
					<table class="table table-hover">
						...
						<?php foreach($res as $r): ?>
							<tr>
								<td>
									<a href="verMediosPago.php?id=<?php echo $r['id']; ?>"><?php echo $r['nombre']; ?></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
				<?php else: ?>
					<p class="text-info mt-3">No hay medios de pago registrados</p>
				<?php endif; ?>
			</div>
		</div>
	</div>
